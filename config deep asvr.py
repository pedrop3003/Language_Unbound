...
#project structure
args["CODE_DIRECTORY"] = "/home/langunbound/Desktop/translate_project/deep_avsr-master/video_only"   #absolute path to the code directory
args["DATA_DIRECTORY"] = "/home/langunbound/Desktop/translate_project/deep_avsr-master/video_only/data"   #absolute path to the data directory
args["DEMO_DIRECTORY"] = "/home/langunbound/Desktop/translate_project/deep_avsr-master/video_only"   #absolute path to the demo directory
args["PRETRAINED_MODEL_FILE"] = "/home/langunbound/Desktop/translate_project/deep_avsr-master/video_only/final/models/trained_model.pt"     #relative path to the pretrained model file
args["TRAINED_MODEL_FILE"] = "/final/models/trained_model.pt"   #relative path to the trained model file
args["TRAINED_LM_FILE"] = "/home/langunbound/Desktop/translate_project/deep_avsr-master/vfandlm/language_model.pt"  #absolute path to the trained language model file
args["TRAINED_FRONTEND_FILE"] = "/home/langunbound/Desktop/translate_project/deep_avsr-master/vfandlm/visual_frontend.pt" #absolute path to the trained visual frontend file
